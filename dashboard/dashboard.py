...
year_options.insert(0, "All Years (2016, 2017, 2018)")

selected_years = st.sidebar.multiselect(
    "Pilih Tahun",
    options=year_options,
    default=year_options[1:]  # default ke tahun terakhir
)

# Konversi pilihan ke bentuk tahun numerik
if "All Years (2016, 2017, 2018)" in selected_years:
    filter_years = all_years
else:
